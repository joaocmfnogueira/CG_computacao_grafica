...
const lerpConfig_esphere1 = {
  destination: new THREE.Vector3(6.0, 1, -5.0),
  alpha: 0.04,
  move: false
}

const lerpConfig_esphere2 = {
  destination: new THREE.Vector3(6.0, 1, 5.0),
  alpha: 0.01,
  move: false
}
...
function buildInterface()
{
  var controls = new function ()
  {
    this.esphere1_moving = function(){
      lerpConfig_esphere1.move = true;
    };
    this.esphere2_moving = function(){
      lerpConfig_esphere2.move = true;
    };
    this.reseting = function(){
      esphere1.position.set(-6,1,-5);
      esphere2.position.set(-6,1, 5);
      lerpConfig_esphere1.move = false;
      lerpConfig_esphere2.move = false;
    };
  };
