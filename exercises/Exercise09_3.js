...
var lightPosition = new THREE.Vector3(4, 8, 0.0);
...
// Caixa
let geometry = new THREE.BoxGeometry(2, 1.4, 2);
let cubeMaterials = [
    setMaterial('../assets/textures/papelao.jpg', 1, 1),
    setMaterial('../assets/textures/papelao.jpg', 1, 1),
    null,
    setMaterial('../assets/textures/papelao.jpg', 1, 1),
    setMaterialWithOpacity(),
    setMaterial('../assets/textures/papelao.jpg', 1, 1)
];
...
// Bola
let ballGeometry = new THREE.SphereGeometry(0.8);
let ballMaterial = setMaterial('../assets/textures/basket.png', 1, 1);
...
function setMaterialWithOpacity(){
    let mat = new THREE.MeshLambertMaterial({ color:'rgba(10, 126, 161, 1)'});
    mat.side = 2;
