...
var cylinderMaterial3 = new THREE.MeshLambertMaterial( {color:'rgba(250, 246, 23, 1)'} );
...
var cylinderMaterial4 = new THREE.MeshLambertMaterial( {color:'rgba(250, 246, 23, 1)'} );
...
function rotateCylinder()
{
  ...
  if(animationOn)
  {
    ...
    cylinder3.matrix.identity();  // reset matrix
    ...
    cylinder3.matrix.multiply(mat4.makeRotationZ(THREE.MathUtils.degToRad(90))); // R2
    cylinder4.matrix.multiply(mat4.makeRotationY(-angle2));
    cylinder4.matrix.multiply(mat4.makeTranslation(0.0, -0.5, 0.0)); // T1
    cylinder4.matrix.multiply(mat4.makeRotationZ(THREE.MathUtils.degToRad(90))); // R2
   }
}
